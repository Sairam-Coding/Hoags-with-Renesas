...
src/smc_gen/r_bsp/mcu/rl78_g16/%.obj: ../src/smc_gen/r_bsp/mcu/rl78_g16/%.c 
	...
	ccrl -subcommand="src\smc_gen\r_bsp\mcu\rl78_g16\cDepSubCommand.tmp" -o "$(@:%.obj=%.d)" -MT="$(@:%.obj=%.obj)" -MT="$(@:%.obj=%.d)" -msg_lang=english "$<"
	ccrl -subcommand="src\smc_gen\r_bsp\mcu\rl78_g16\cSubCommand.tmp" -msg_lang=english -o "$(@:%.d=%.obj)" "$<"
