...
static void __near r_Config_TAU0_3_interrupt(void)
{
    ...
    g_pulse_width1[4U - g_times1] = g_tau0_ch3_width;


    if (0U == ( --g_times1))        /* 8 times measurement finished ? */
    {
        R_Config_TAU0_3_Stop();    /* Stops timer counter */
    }
//    if(g_times1==0)
//    {
//		if(((g_pulse_width1[0] > 3000 && g_pulse_width1[0] < 4000)  &&  (g_pulse_width1[1] >2000 && g_pulse_width1[1] < 3000)  &&  (g_pulse_width1[0] > 3000 && g_pulse_width1[0] < 4000) )  ||   ((g_pulse_width1[0] > 2000 && g_pulse_width1[0] < 3000)  &&  (g_pulse_width1[1] >3000 && g_pulse_width1[1] < 4000)  &&  (g_pulse_width1[0] > 2000 && g_pulse_width1[0] < 3000)))
//		{
//			uart_integer(9);
