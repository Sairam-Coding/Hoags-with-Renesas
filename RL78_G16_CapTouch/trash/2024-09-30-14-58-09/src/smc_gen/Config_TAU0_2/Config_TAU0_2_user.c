...
static void __near r_Config_TAU0_2_interrupt(void)
{
    ...
    g_pulse_width[4 - g_times] = g_tau0_ch3_width;
        if((--g_times) == 0)
        {
        	if(((g_pulse_width[1] > 3000 && g_pulse_width[1] < 4000) && (g_pulse_width[2] > 2000 && g_pulse_width[2] < 3000) && (g_pulse_width[3] > 3000 && g_pulse_width[3] < 4000))   ||  ((g_pulse_width[1] > 2000 && g_pulse_width[1] < 3000) && (g_pulse_width[2] > 3000 && g_pulse_width[2] < 4000) && (g_pulse_width[3] > 2000 && g_pulse_width[3] < 3000) ))
        	{
        		if(comvar)
        		{
        			confirmed = 1;
