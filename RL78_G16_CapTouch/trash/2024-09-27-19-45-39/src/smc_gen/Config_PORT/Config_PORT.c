...
void R_Config_PORT_Create(void)
{
    ...
    PM1 = _80_PMn7_NOT_USE | _40_PMn6_NOT_USE | _20_PMn5_NOT_USE | _00_PMn4_MODE_OUTPUT | _00_PMn3_MODE_OUTPUT | 
          _00_PMn2_MODE_OUTPUT | _00_PMn1_MODE_OUTPUT | _01_PMn0_NOT_USE;
    /* Set PORT2 registers */
    ...
    PM4 = _F0_PM4_DEFAULT | _08_PMn3_NOT_USE | _00_PMn2_MODE_OUTPUT | _02_PMn1_NOT_USE | _01_PMn0_NOT_USE;
    /* Set PORT6 registers */
    P6 = _00_Pn1_OUTPUT_0 | _00_Pn0_OUTPUT_0;
    PM6 = _FC_PM6_DEFAULT | _00_PMn1_MODE_OUTPUT | _00_PMn0_MODE_OUTPUT;
    ...
    TSSEL0 &= _EF_TSSEL04_TOUCH_PIN_NOT_USE & _DF_TSSEL05_TOUCH_PIN_NOT_USE;
    TSSEL1 &= _FB_TSSEL10_TOUCH_PIN_NOT_USE & _F7_TSSEL11_TOUCH_PIN_NOT_USE & _DF_TSSEL13_TOUCH_PIN_NOT_USE;
